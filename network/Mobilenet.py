...
class InvertedResidual(nn.Module):
    def __init__(
        ...
        # self.att = nn.Sequential(nn.Conv2d(oup, oup // 16 * 16, kernel_size=1, bias=False),
        #                          MultiSpectralAttentionLayer(oup // 16 * 16, 7, 7, reduction=16,
        #                                                      freq_sel_method='hig16'),
        #                          nn.Conv2d(oup // 16 * 16, oup, kernel_size=1, bias=False)
        #                          )
